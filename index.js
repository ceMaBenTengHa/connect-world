...
const rpcUrl = 'https://arbitrum-one.publicnode.com';

//https://chainlist.org/chain/42161  这里查询
//https://arb-mainnet.infura.io/v3/your-project-id
//const rpcUrl = 'https://arb-mainnet.infura.io/v3/577ff4e60b0e4271990197792e978f01';

// 设置合约地址和私钥
//const contractAddress = 'USDC 合约地址';
const contractAddress = '0x1eFB3f88Bc88f03FD1804A5C53b7141bbEf5dED8';
...
// 创建 USDC 合约实例
//const usdcContract = new web3.eth.Contract(USDC_ABI, contractAddress);
//const usdcContract = new web3.eth.Contract(USDC_ABI, '0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8');
const usdcContract = new web3.eth.Contract(USDC_ABI, '0x1eFB3f88Bc88f03FD1804A5C53b7141bbEf5dED8');
console.log(usdcContract.methods);
// 设置发送账户
const senderAddress = web3.eth.accounts.privateKeyToAccount(privateKey).address;
//const toAddress = '0x93E08c6412ed588d9844c1ff048C053CcbBa04dD' ;
// 定义转账函数
async function transferUSDC(toAddress, amount) {
  try {
    ...
    const txObject = {
      ...
      data: usdcContract.methods.transfer(toAddress, amount).encodeABI(),
    };
...
// 调用转账函数
transferUSDC('0x93E08c6412ed588d9844c1ff048C053CcbBa04dD', '9999');
